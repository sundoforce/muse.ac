...
const INITIALIZE = 'ensembleWrite/INITIALIZE'; // 모든 내용 초기화
const CHANGE_FIELD = 'ensembleWrite/CHANGE_FIELD'; // 특정 key 값 바꾸기
const [
    WRITE_ENSEMBLE,
    WRITE_ENSEMBLE_SUCCESS,
    WRITE_ENSEMBLE_FAILURE,
] = createRequestActionTypes('ensembleWrite/WRITE_ENSEMBLE'); // 포스트 작성
const SET_ORIGINAL_ENSEMBLE = 'ensembleWrite/SET_ORIGINAL_ENSEMBLE';
const [
    UPDATE_ENSEMBLE,
    UPDATE_ENSEMBLE_SUCCESS,
    UPDATE_ENSEMBLE_FAILURE,
] = createRequestActionTypes('ensembleWrite/UPDATE_ENSEMBLE'); // 포스트 수정
